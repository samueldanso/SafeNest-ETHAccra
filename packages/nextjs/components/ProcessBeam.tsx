...
export function ProcessBeam({ className }: { className?: string }) {
  ...
  return (
    <MagicCard className="flex relative items-center justify-center bg-card" gradientColor="#D9D9D955">
      ...
      >
        ...
        <AnimatedBeam containerRef={containerRef} fromRef={div1Ref} toRef={div6Ref} duration={5} />
        <AnimatedBeam containerRef={containerRef} fromRef={div3Ref} toRef={div6Ref} duration={5} delay={1} />
        <AnimatedBeam containerRef={containerRef} fromRef={div5Ref} toRef={div6Ref} duration={5} delay={2} />
        <AnimatedBeam containerRef={containerRef} fromRef={div6Ref} toRef={div7Ref} duration={5} delay={3} />
      </div>
    </MagicCard>
  );
}
